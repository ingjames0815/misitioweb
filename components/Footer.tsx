      ...
      <div className="container mx-auto px-6 py-8">
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex items-center space-x-2">
                ...
                <span className="text-xl font-bold text-slate-800">PLANIFICA T</span>
            </div>
            <p className="text-slate-500 text-center">&copy; {new Date().getFullYear()} PLANIFICA T. Todos los derechos reservados.</p>
